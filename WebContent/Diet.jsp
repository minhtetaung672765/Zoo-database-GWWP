...
<form action="Diet_action.jsp" method="post">

<label for="Dtype">Diet type </label>
<input id="Dtype" type="text" name="dtype" ><br><br>

<label for="NOF">Number of feed per day </label>
<input id="NOF" type="text" name="nfeed" required><br><br>
